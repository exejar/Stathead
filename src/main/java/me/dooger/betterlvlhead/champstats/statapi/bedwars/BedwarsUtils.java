package me.dooger.betterlvlhead.champstats.statapi.bedwars;


import me.dooger.betterlvlhead.champstats.statapi.HGameBase;
import me.dooger.betterlvlhead.champstats.statapi.stats.StatInt;
import me.dooger.betterlvlhead.champstats.utils.MathUtils;
...
public abstract class BedwarsUtils extends HGameBase {
    ...
    public double getWlr(Bedwars bw) {
        return MathUtils.formatDouble(((StatInt)bw.wins).getValue(), ((StatInt)bw.losses).getValue());
    }
    ...
    public double getBblr(Bedwars bw) {
        return MathUtils.formatDouble(((StatInt)bw.bedsBroken).getValue(), ((StatInt)bw.bedsLost).getValue());
    }
